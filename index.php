    ...
    <div id="main_container" class="dark">
        <header id="header" class="dark">
            ...
            <div class="genre_container navbar">
                ...
                <div id="kpop" class="genre dark list-item" data-filter="GN0200">K-Pop</div>
                <div id="rap" class="genre dark list-item" data-filter="GN0300">Rap/Hiphop</div>
                <div id="rb" class="genre dark list-item" data-filter="GN0400">R&B</div>
                <div id="indie" class="genre dark list-item" data-filter="GN0500">Indie</div>
                <div id="rock" class="genre dark list-item" data-filter="GN0600">Rock</div>
                <div id="balad" class="genre dark list-item" data-filter="GN0100">Balad</div>
